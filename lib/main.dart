...
import 'package:syk_flutter/page/WelcomePage.dart';
...
class FlutterReduxApp extends StatelessWidget {
  final store = new Store<SYKState>(appReducer,
      initialState: new SYKState(userInfo: User.empty()));
  FlutterReduxApp({Key key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return new StoreProvider(
      store: store,
      child: new StoreBuilder<SYKState>(builder: (context, store) {
