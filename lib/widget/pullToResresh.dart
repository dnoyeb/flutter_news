...
class PullToRefreshWidget extends StatefulWidget {
  ...
  ///控制器，比如数据和一些配置
  final PullToRefreshWidgetControl control;
...
class _PullToRefreshWidgetState extends State<PullToRefreshWidget> {
  ...
  PullToRefreshWidgetControl control;

  _PullToRefreshWidgetState(this.control, this.itemBuilder, this.onRefresh,
...
class PullToRefreshWidgetControl {
  ///数据，对齐增减，不能替换
